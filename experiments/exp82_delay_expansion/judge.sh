#!/bin/bash
# usage: judge.sh TAU [--delay-exp] [--figures] [--best NAME] [--also NAMES] — merge the grid point's starts and judge it
...
TAU=$1; shift
FORM=""; TABLES="--tables-only"; BEST=""; ALSO=""
while [ $# -gt 0 ]; do case "$1" in --delay-exp) FORM="--delay-exp";; --figures) TABLES="";; --best) BEST="--best $2"; shift;; --also) ALSO="--also $2"; shift;; esac; shift; done
