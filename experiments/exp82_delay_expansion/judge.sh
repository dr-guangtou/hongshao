...
uv run python -u experiments/exp80_deposit_size_law/stage1_eval.py $TABLES --fit-tag _delay${TAU}${EXP}_fix-tau_d${TAU} --delay $FORM $BEST --outdir $OUT > $OUT/eval_tau${TAU}${EXP}.log 2>&1
